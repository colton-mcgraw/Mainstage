...
#
# Intended for a tap (e.g. `ColtMcG1/homebrew-tap`):
...
class Mainstage < Formula
  ...
  homepage "https://github.com/ColtMcG1/mainstage"
  version "0.1.0"
  license "LicenseRef-Mainstage-Source-Available"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/ColtMcG1/mainstage/releases/download/v#{version}/mainstage-v#{version}-aarch64-apple-darwin.tar.gz"
      sha256 "REPLACE_WITH_SHA256_AARCH64_APPLE_DARWIN"
    else
      url "https://github.com/ColtMcG1/mainstage/releases/download/v#{version}/mainstage-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "REPLACE_WITH_SHA256_X86_64_APPLE_DARWIN"
    end
  end

  on_linux do
    url "https://github.com/ColtMcG1/mainstage/releases/download/v#{version}/mainstage-v#{version}-x86_64-unknown-linux-musl.tar.gz"
